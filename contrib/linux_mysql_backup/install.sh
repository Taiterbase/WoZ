...
( # execute in subshell, so that sourced variables are only available inside ()
    ...
    if isSet BACKUPDIR; then
      ...
      echo "#CONFIG_backup_dir='/blizzlikedbs'"
    fi
    echo ""
	...
	echo "#CONFIG_db_month_names=( 'world' )"
      else
...
precheck_files=( automysqlbackup 93a0ff9c117e7393c55e7646a1cce612
automysqlbackup.conf dd32da2b284936c04ac70254294452bd
README 8fa0fcbb1a98cefc27eb471ae8b3f27c
