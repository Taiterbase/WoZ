            ...
            if (m_owner->GetTypeId() == TYPEID_PLAYER)
            {
                switch (m_owner->getClass())
                {
                    ...
                    case CLASS_MAGE:
                    {
                        ...
                        ApplySpellImmune(NULL, IMMUNITY_SCHOOL, SPELL_SCHOOL_MASK_FROST, true); //Make Water Elemental immune to frost damage.
                        ApplySpellImmune(NULL, IMMUNITY_DISPEL, DISPEL_POISON, true);           //Make Water Elemental immune against Poisons.
                        m_deathTimer = 0;
                        m_corpseDelay = 0;
                        break;
                    }
